...
<form class="w-full mx-auto max-w-screen-xl p-4 flex flex-col gap-4 grow">
  <h1 class="self-center font-black text-3xl"> Créer votre post ici</h1>
  ...
  <div>
    <h3> Title :</h3>
    <input type="text" name="title" class="border-2 border-black rounded-lg w-full p-1" required>
  </div>

  <div>
    <h3> Author :</h3>
    <input type="text" name="author" class="border-2 border-black rounded-lg w-full p-1" required>
  </div>
  ...
  <div class="flex flex-col grow">
    <h3> Content :</h3>
    <textarea name="content" class="border-2 border-black rounded-lg p-2 w-full grow" required/>
  </div>

  <div class="flex flex-row justify-center gap-5">
    <input type="submit" value="Envoyer" name="submit" class="w-32 h-10 cursor-pointer rounded-2xl bg-blue-600 text-white">
  </div>
</form>
