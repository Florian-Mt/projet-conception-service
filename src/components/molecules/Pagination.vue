...
<template>
  <nav class="flex items-center gap-4" aria-label="Naviguer dans les pages">
    <router-link v-if="firstItem > 1" :to="{name: 'HomePage'}">
      <span href="#" class="flex items-center justify-center px-3 h-8 ms-0 leading-tight text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
    ...
    <router-link v-if="lastItem < pagesCount" :to="{name: 'HomePage', params: {pageNumber: pagesCount}}">
      <span class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
